...
public class Configuration {
    ...
    private static final String CONFIGURATION_FILE = "pop.properties";
    ...
    static {
        ...
        try (InputStream inputStream = new FileInputStream("src/main/java/com/edencoding/pop.properties");) {
