...
public class E1204 {
    static String J20;
    static AtomicInteger nbtasks;
    public static void main(String[] args) throws InvalidPasswordException, IOException {
      AtomicInteger nbtasks = new AtomicInteger(0);
     PdfReader pdfReader = new PdfReader("E1224.pdf");
 ...
 PdfReader pdfReader1 = new PdfReader("E1221.pdf");

 String [][] E1201 = tart.starte1201(pdfReader1);
 
 PDFMergerUtility pdfmerger = new PDFMergerUtility();
 File filepdf = new File ("E1224.pdf");
 PDDocument document = PDDocument.load(filepdf);
 File filepdfE1221 = new File ("E1221.pdf");
...
LabelTotal(array.size(),mainViewController);
...
public static void LabelTotal(int valuetotal, MainViewController mainViewController) {

 
    Label Labeltotal = mainViewController.getTotal();
  
    Labeltotal.setText("Pièces crées: "+Integer.toString(valuetotal));
